...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Muzammil"
  # spec.authors            = { "Muzammil" => "muzammilinnovativesol@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Muzammil"
  ...
  spec.source       = { :git => "https://github.com/muhammadmuzzamil/ChatSDK.git", :branch => "master", :tag => "1.2" }
